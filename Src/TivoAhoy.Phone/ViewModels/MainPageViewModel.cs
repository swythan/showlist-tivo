    ...
    public class MainPageViewModel : Screen
    {
        ...
        public void RefreshShows()
        {
            ...
            using (var connection = new TivoConnection())
            {
                try
                {
                    var tivoIPAddress = "192.168.0.18";
                    var mediaAccessKey = "9837127953";

                    connection.Connect(tivoIPAddress, mediaAccessKey);
                ...
                {
                    this.Items.Add(new ItemViewModel() { LineOne = show.Title, LineTwo = show.ItemType, LineThree = show.Id });
                }
            }
        }
    }
